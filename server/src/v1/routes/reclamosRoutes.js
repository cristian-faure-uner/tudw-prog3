 ...
 */
router.get('/:idReclamo', autorizarUsuarios([3]), reclamosController.buscarPorId);
 ...
 */
router.post('/', autorizarUsuarios([3]), reclamosController.crear);
 ...
 *                   example: "Faltan datos obligatorios"
 */
router.patch('/atencion/:idReclamo', autorizarUsuarios([2]), reclamosController.atencionReclamo);
